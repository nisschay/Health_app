      ...
      <ResponsiveContainer width="100%" height={280}>
        {isSinglePoint ? (
          ...
          <AreaChart data={chartData} margin={{ top: 16, right: 24, bottom: 16, left: 8 }}>
            ...
            <Tooltip
              contentStyle={{ background: "#1e1e2e", border: "1px solid #6366f1", borderRadius: 8, color: "#f1f5f9" }}
            ...
            <Area type="monotone" dataKey="value" stroke="#6366f1" fill="#6366f133" strokeWidth={2} dot={{ fill: "#6366f1", r: 6 }} activeDot={{ r: 8 }} />
          </AreaChart>
        ) : (
          <LineChart data={chartData} margin={{ top: 16, right: 24, bottom: 16, left: 8 }}>
            ...
            <Line
              ...
              dot={(props) => {
                ...
                const color = d?.status?.toLowerCase() === "normal" ? "#22c55e" : d?.status?.toLowerCase() === "high" || d?.status?.toLowerCase() === "low" ? "#f59e0b" : "#6366f1";
